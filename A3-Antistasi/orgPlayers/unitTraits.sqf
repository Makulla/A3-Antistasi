...
else
{
    switch (_type) do
    {
    	...
    	case "I_G_medic_F":  {player setUnitTrait ["loadCoef",0.5]; player setUnitTrait ["UAVHacker",true]; player setUnitTrait ["engineer",true]; player setUnitTrait ["explosiveSpecialist",true]; _text = "Superhuman role.<br/><br/>Double carrying capacity, Explosive perks, Medic perks, HACKERMAN perk."}; //adapted by Schnitzel on 25th of april
